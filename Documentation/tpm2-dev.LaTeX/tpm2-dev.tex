		...
		\begin{center}
			\begin{minipage}{.6\textwidth}
				...
				\begin{tabular}{|c|l|}
					...
					0x0b & size: u64 \\
					\hline
					0x13 & sha1 sum: 20 bytes \\
					\hline
					0x27 & zero-terminated absolute path \\
					\hline
				\end{tabular}
			\end{minipage}
		\end{center}
