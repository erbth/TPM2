...
\begin{document}
	...
	\section{A new transport form}
	\label{sec:a_new_transport_form}
	...
	\begin{center}
		\begin{tabular}{|l|c|c|c|}
			...
			\hline
			0x0000 & major version: u8 (= 1) & count of sections: u8 & \\
			\hline
	...
	\begin{tabularx}{\textwidth}{c|c|X}
		...
		0x01 & no & \script{preinst} script \\
		0x02 & no & \script{configure} script \\
		0x03 & no & \script{unconfigure} script \\
		0x04 & no & \script{postrm} script \\
	...
	By the way, compression. The archive maybe compressed using any technique one likes, and that the package manager supports.
